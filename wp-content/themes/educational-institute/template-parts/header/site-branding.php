      ...
      <div class="col-lg-3 col-md-4 col-9 align-self-center">
        ...
        if($elearning_education_logo_settings == 'Different Line'){ ?>
          <div class="logo">
            ...
            <?php }?>
            <?php $educational_institute_description = get_bloginfo( 'description', 'display' );
            if ( $educational_institute_description || is_customize_preview() ) : ?>
              <?php if(get_theme_mod('elearning_education_site_tagline',true) != ''){ ?>
                <p class="site-description mb-0"><?php echo esc_html($educational_institute_description); ?></p>
              <?php }?>
            <?php endif; ?>
          </div>
